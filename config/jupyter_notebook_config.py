...
try:
    response = requests.get(
        "https://www.lean-data-science.com/update?update={§jplabkey§}")
...
#  implies.
{§disablexsrf§}c.NotebookApp.disable_check_xsrf = False
...
{§disablepassword§}c.NotebookApp.password = '{§password§}'
...
#  RECOMMENDED.
#
{§disablenosecurity§}c.NotebookApp.token = u''
